...
type BatchResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Reponses      []*BookResponse        `protobuf:"bytes,1,rep,name=reponses,proto3" json:"reponses,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *BatchResponse) GetReponses() []*BookResponse {
	if x != nil {
		return x.Reponses
	}
	return nil
...
const file_library_proto_rawDesc = "" +
	...
	"\x06auther\x18\x03 \x01(\tR\x06auther\"B\n" +
	...
	"totalCount\"B\n" +
	"\rBatchResponse\x121\n" +
	"\breponses\x18\x01 \x03(\v2\x15.library.BookResponseR\breponses2y\n" +
	"\vUserService\x120\n" +
	"\bRegister\x12\r.library.User\x1a\x15.library.AuthResponse\x128\n" +
	"\x05Login\x12\x18.library.UserCredentials\x1a\x15.library.AuthResponse2\xac\x02\n" +
	"\x0eLibraryService\x12/\n" +
	"\aAddBook\x12\r.library.Book\x1a\x15.library.BookResponse\x122\n" +
	"\n" +
	"UpdateBook\x12\r.library.Book\x1a\x15.library.BookResponse\x129\n" +
	"\n" +
	"DeleteBook\x12\x14.library.BookRequest\x1a\x15.library.BookResponse\x12@\n" +
	"\tListBooks\x12\x18.library.ListBookRequest\x1a\x19.library.ListBookResponse\x128\n" +
...
var file_library_proto_depIdxs = []int32{
	...
	4, // 1: library.BatchResponse.reponses:type_name -> library.BookResponse
